...
//обновление токена и тикета
//TODO: 1. Для каждой сущности должен быть предоставлен полный список операций CRUD
//Для User добавил возможность смены пароля
//Для LicenseHistory добавил возможность просмотра истории по айди, удаление всего, и удаление истории связанной с конкретной лицензией
//Для LicenseType добавил возможность поменять количество месяцев, если еще не было создано с ним лицензий
//Device теперь можно удалять, а так же авторизированный пользователь может посмотреть свои устройства
